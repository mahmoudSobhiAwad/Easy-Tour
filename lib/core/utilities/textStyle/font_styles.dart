...
static const resetPassTitle=TextStyle(color: basicColor, fontSize: 30, fontFamily: 'ABeeZee', fontWeight: FontWeight.bold,);
static const privateTourTitle=TextStyle(color: basicColor, fontSize: 21, fontFamily: 'ABeeZee', fontWeight: FontWeight.bold,overflow: TextOverflow.ellipsis);
...
static const commonFontThin=TextStyle(fontSize: 14,color: basicColor,overflow: TextOverflow.ellipsis,);
static const commonFontThinNoOverFlow=TextStyle(fontSize: 14,color: basicColor,);
