...
class _HomeTouristViewState extends State<HomeTouristView> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocProvider(
      create: (context)=>HomeTouristCubit(controller: animationController,homeTouristRepoImp: getIt.get<HomeTouristRepoImp>(),settingRepoImp: getIt.get<SettingRepoImp>())..connect()..getBestDestination(),
