  ...
  Future<void>requestGenerateTrip()async{
    ...
    if(checkBeforeSend()){
      ...
      result.fold((failure){
        ...
        {
          emit(SuccessSendRequestToGenerateTrip(startDate:destinationWithDayList.first.startDate,model:generatedTrip,endDate: destinationWithDayList.last.lastDate ));
        }
      });
    }
  }
