...
class GeneratedTripDetailsView extends StatelessWidget {
  const GeneratedTripDetailsView({super.key});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListOfDaysOfTrip(height: height, currentDay: cubit.currentDay,controller: cubit.controller, width: width),
                    Expanded(
                      child: SizedBox(
                          height: height*0.6,
                          child: ListView.builder(
                            ...
                            itemBuilder: (context,index){
                              return OneTripPerDayItem(height: height, width: width);
                              },
                          )
                      ),
                    ),
