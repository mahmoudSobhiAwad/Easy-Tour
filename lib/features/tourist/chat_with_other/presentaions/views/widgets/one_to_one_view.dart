...
class ChatTouristOneToOtherOne extends StatelessWidget {
  const ChatTouristOneToOtherOne({super.key,required this.height,required this.width,this.chatId});
  final double height;
  final double width;
  final String? chatId;
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create:(context)=>ChatOneToOneCubit(chatID:chatId,chatOTORepoImp: getIt.get<ChatOTORepoImp>())..getAllChatOTO(chatId),
